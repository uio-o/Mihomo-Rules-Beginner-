proxy-groups:
  ...
  - name: 自动选择
    ...
    type: url-test
    include-all: true
    exclude-filter: (?i)家宽|家庭|商宽|落地|FAM|FAM|HKT|HKBN|HGC|iCable|Eons
    interval: 300
    tolerance: 20
    lazy: false
  - name: 人工智能
  ...
  - name: 澳门节点
    ...
    include-all: true
    filter: (?i)澳门|Macau|Macao|澳門|Macau SAR|Macau S.A.R.|澳門特區|澳門特区|澳门特区|Macau Special Administrative Region
    exclude-filter: (?i)家宽|家庭|商宽|落地
    type: url-test
    interval: 300
    tolerance: 20
  ...
  - name: 欧盟节点
    ...
    include-all: true
    filter: (?i)奥地利|Austria|AUT|AT|维也纳|Vienna|比利时|Belgium|BEL|BE|布鲁塞尔|Brussels|根特|Ghent|安特卫普|Antwerp|保加利亚|Bulgaria|BGR|BG|索菲亚|Sofia|克罗地亚|Croatia|HRV|HR|萨格勒布|Zagreb|塞浦路斯|Cyprus|CYP|CY|尼科西亚|Nicosia|捷克|Czechia|Czech|CZE|CZ|布拉格|Prague|丹麦|Denmark|DNK|DK|哥本哈根|Copenhagen|欧登塞|Odense|爱沙尼亚|Estonia|EST|塔林|Tallinn|芬兰|Finland|FIN|FI|赫尔辛基|Helsinki|法国|France|FRA|FR|巴黎|Paris|马赛|Marseille|里昂|Lyon|德国|Germany|DEU|法兰克福|Frankfurt|柏林|Berlin|慕尼黑|Munich|杜塞尔多夫|Dusseldorf|汉堡|Hamburg|希腊|Greece|GRC|EL|GR|雅典|Athens|匈牙利|Hungary|HUN|布达佩斯|Budapest|爱尔兰|Ireland|IRL|IE|都柏林|Dublin|意大利|Italy|ITA|IT|米兰|Milan|罗马|Rome|拉脱维亚|Latvia|LVA|LV|里加|Riga|立陶宛|Lithuania|LTU|LT|维尔纽斯|Vilnius|卢森堡|Luxembourg|LUX|LU|卢森堡市|卢森堡|马耳他|Malta|MLT|MT|瓦莱塔|Valletta|荷兰|Netherlands|NLD|NL|阿姆斯特丹|Amsterdam|鹿特丹|Rotterdam|波兰|Poland|POL|华沙|Warsaw|克拉科夫|Krakow|葡萄牙|Portugal|PRT|PT|里斯本|Lisbon|波尔图|Porto|罗马尼亚|Romania|ROU|RO|布加勒斯特|Bucharest|斯洛伐克|Slovakia|SVK|SK|布拉迪斯拉发|Bratislava|斯洛文尼亚|Slovenia|SVN|SI|卢布尔雅那|Ljubljana|西班牙|Spain|ESP|马德里|Madrid|巴塞罗那|Barcelona|瑞典|Sweden|SWE|SE|斯德哥尔摩|Stockholm|马尔默|Malmö|Malmo|奥斯陆|Oslo|挪威|Norway|NOR|NO|冰岛|Iceland|ISL|IS|雷克雅未克|Reykjavik|波罗的海|Baltic|Baltics
    exclude-filter: (?i)家宽|家庭|商宽|落地
    type: url-test
    interval: 300
    tolerance: 20
    lazy: false
  - name: 南美节点
    icon: https://cdn.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/America_Map.png
    include-all: true
    filter: (?i)墨西哥|Mexico|MEX|MX|危地马拉|Guatemala|GTM|GT|伯利兹|Belize|BLZ|BZ|洪都拉斯|Honduras|HND|HN|萨尔瓦多|El Salvador|SLV|SV|尼加拉瓜|Nicaragua|NIC|NI|哥斯达黎加|Costa Rica|CRI|CR|巴拿马|Panama|PAN|PA|古巴|Cuba|CUB|CU|多米尼加共和国|Dominican Republic|DOM|DO|海地|Haiti|HTI|HT|委内瑞拉|Venezuela|VEN|VE|哥伦比亚|Colombia|COL|CO|厄瓜多尔|Ecuador|ECU|EC|秘鲁|Peru|PER|PE|玻利维亚|Bolivia|BOL|BO|智利|Chile|CHL|CL|阿根廷|Argentina|ARG|AR|乌拉圭|Uruguay|URY|巴拉圭|Paraguay|PRY|PY|巴西|Brazil|BRA|BR。
    exclude-filter: (?i)家宽|家庭|商宽|落地
    type: url-test
    interval: 300
    tolerance: 20
